...
export default function SagunProvider({ children }: SagunProviderProps): ReactNode {
    ...
    if (!store || !operationService || !componentLifecycleService) {
        // Should not happen because component is used within BrowserOnly
        return null;
    }
...
export { store, operationService, componentLifecycleService };
